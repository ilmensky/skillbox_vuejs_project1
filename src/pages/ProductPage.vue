<template>
  ...
  <main class="content container" v-else-if="productLoadingFailed">Не удальсь получить товар.</main>
      ...
      <div class="item__info">
        ...
        <div class="item__form">
          <form class="form" action="#"
                @submit.prevent="addToCart" method="POST">
            <b class="item__price">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li class="colors__item">
                  <label class="colors__label" for="cp1">
                    <input class="colors__radio sr-only" type="radio" name="color-item" id="cp1"
                           value="blue" checked="">
                ...
                <li class="colors__item">
                  <label class="colors__label" for="cp2">
                    <input class="colors__radio sr-only" type="radio" name="color-item" id="cp2"
                           value="yellow">
                ...
                <li class="colors__item">
                  <label class="colors__label" for="cp3">
                    <input class="colors__radio sr-only" type="radio" id="cp3"
            ...
            <fieldset class="form__block">
              ...
              <ul class="sizes sizes--primery">
                <li class="sizes__item">
                  <label class="sizes__label" for="s1">
                    <input class="sizes__radio sr-only"
                           id="s1" type="radio" name="sizes-item" value="32">
                ...
                <li class="sizes__item">
                  <label class="sizes__label" for="s2">
                    <input class="sizes__radio sr-only" type="radio"
                           id="s2" name="sizes-item" value="64">
                    <span class="sizes__value">
                      64gb
                    </span>
                  </label>
                ...
                <li class="sizes__item">
                  <label class="sizes__label" for="s3">
                    <input class="sizes__radio sr-only" type="radio"
                           id="s3" name="sizes-item" value="128" checked="">
                    <span class="sizes__value">
                      128gb
                    </span>
                  </label>
